...
public class Java_03_기본형 {
	...
	public static void main(String[] args) {
		...
		// - 정수형에서 가장 자주 사용하는 int는 4바이트다.
		// - long형은 8byte크기를 가진다. int보다 더 큰 범위의 정수를 표현하고 싶을 때 사용한다.
		
		// 실수형
		// - 실수형은 float과 double형이 있다.
		// - float은 4바이트, double은 8바이트로 double float보다 더 큰 범위의 실수를 표현할 수 있다.
